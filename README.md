...
**Base URL**: `https://peixuan-api.workers.dev`
...
4. **Actions** → Create new action → Import URL:
   ```
   https://peixuan-api.workers.dev/openapi.json
   ```
