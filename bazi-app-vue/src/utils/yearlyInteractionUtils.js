...
export class YearlyInteractionAnalyzer {
    // 天干五合
    static HEAVENLY_STEM_COMBINATIONS = {
        '甲': '己', '乙': '庚', '丙': '辛', '丁': '壬', '戊': '癸',
        '己': '甲', '庚': '乙', '辛': '丙', '壬': '丁', '癸': '戊',
    };
    // 天干相沖
    static HEAVENLY_STEM_CLASHES = {
        '甲': '庚', '乙': '辛', '丙': '壬', '丁': '癸',
        '戊': null, '己': null, // 戊己土無沖
        '庚': '甲', '辛': '乙', '壬': '丙', '癸': '丁',
    };
    // 地支六合
    static EARTHLY_BRANCH_COMBINATIONS = {
        '子': '丑', '丑': '子',
        '寅': '亥', '亥': '寅',
        '卯': '戌', '戌': '卯',
        '辰': '酉', '酉': '辰',
    ...
    // 丑未戌三刑: 丑刑戌, 戌刑未, 未刑丑
    // 子卯相刑
    static EARTHLY_BRANCH_PUNISHMENTS = {
        '子': ['卯'], '卯': ['子'],
        '寅': ['巳', '申'], '巳': ['寅', '申'], '申': ['寅', '巳'],
        '丑': ['戌', '未'], '未': ['丑', '戌'], '戌': ['丑', '未'],
     ...
     * 檢查兩個地支之間的關係：沖、刑、合、害
     */
    static checkBranchRelations(branch1, branch2) {
        const relations = {
            isClashing: false,
            isPunishing: false,
            isCombining: false,
     ...
     * 分析流年與八字的互動
     */
    static analyzeYearlyInteraction(bazi, yearlyFate) {
        const result = {
     ...
     */
    static getInteractionHighlights(interactions) {
...
*/
//# sourceMappingURL=yearlyInteractionUtils.js.map