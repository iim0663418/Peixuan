...
class PurpleStarCalculator {
  ...
  constructor(birthInfo: BirthInfo) {
    ...
    console.log('Converted Lunar Date:', {
      year: this.lunarDate.getYear(),
      month: this.lunarDate.getMonth(),
      day: this.lunarDate.getDay(),
      hour: this.lunarDate.getHour(),
      yearGanzhi: this.lunarDate.getYearInGanZhi(),
      monthGanzhi: this.lunarDate.getMonthInGanZhi(),
      dayGanzhi: this.lunarDate.getDayInGanZhi(),
