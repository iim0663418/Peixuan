...
--> statement-breakpoint
-- Create new composite index on (chart_id, analysis_type)
CREATE INDEX `idx_advanced_analysis_chart_id_type` ON `advanced_analysis_records` (`chart_id`, `analysis_type`);
