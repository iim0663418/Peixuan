...
describe('EnhancedStorageService', () => {
  ...
  it('應該能夠保存和獲取用戶偏好設定', () => {
    ...
    // 驗證時區信息也被單獨保存
    const timeZoneInfo = storageService.getFromStorage<{timeZone: string, timestamp: number}>(ENHANCED_STORAGE_KEYS.TIMEZONE_INFO);
